...
@Service
@Profile("avro")
public class MensagemUseCaseAvroImpl implements MensagemUseCase {
    ...
    @Autowired
    public MensagemUseCaseAvroImpl(KafkaDataSourceImpl kafkaDataSourceImpl, @Value("${spring.kafka.nome-topico}") String nomeTopico) {
