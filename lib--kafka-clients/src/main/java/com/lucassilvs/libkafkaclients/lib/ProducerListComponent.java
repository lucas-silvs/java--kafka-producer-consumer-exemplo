...
public class ProducerListComponent {
    ...
    public static KafkaTemplate buscaProducer(String producerKeyName) {
        return listaProducers.get(producerKeyName);
    }
    ...
    public void listaKafkaTemplate() {
        ...
        ProducerListComponent.listaProducers = producers;
    }
}
